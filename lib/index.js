...
function calculateCharactersPerMessage(parts, singleBytes, multiBytes, charBytes) {
  var max = parts.length === 1 ? singleBytes : multiBytes;
  return max / charBytes;
}
...
module.exports.split = function (message, options) {
  ...
  var perMessage = calculateCharactersPerMessage(splitResult.parts, singleBytes, multiBytes, charBytes);
